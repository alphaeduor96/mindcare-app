          ...
          <div className="min-w-[900px]">
            ...
            <div className="relative">
              {hours.map((hour) => {
                ...
                return (
                  <div key={hour} className="grid grid-cols-8 border-b border-border" style={{ height: "80px" }}>
                    {/* Hour label */}
                    ...
                    <div key={dayIndex} className="relative border-r border-transparent">
                      {dayAppointments.map((appointment) => {
                        ...
                        return (
                          <div
                            key={appointment.id}
                            className={`absolute left-1 right-1 ${appointment.color} text-white rounded p-2 text-xs hover:shadow-lg transition-all pointer-events-auto cursor-pointer z-10 ${
